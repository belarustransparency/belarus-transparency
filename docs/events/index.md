...
<a class="bt-event-row" data-type="conference" href="event-slug/">
  <div class="bt-event-date">
    <div class="bt-event-day">15</div>
    <div class="bt-event-month">авг 2024</div>
  </div>
  <div class="bt-event-type">Конференция</div>
  <div class="bt-event-info">
    <div class="bt-event-title">Название мероприятия</div>
    <div class="bt-event-summary">Краткое описание одной строкой — что произошло, кто организатор.</div>
  </div>
  <div class="bt-event-place">Вильнюс</div>
</a>
