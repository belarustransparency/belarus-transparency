...
<header class="bt-org-head">
  ...
  <p class="bt-lede">Государственный фонд Польши (Skarbu Państwa) под патронатом Президента РП, надзор Министерства иностранных дел. Основной оператор польской помощи развитию по линии «Wsparcie Demokracji» — в том числе на беларуское направление.</p>
...
<section class="bt-org-transparency">
  ...
  <div class="bt-tp-details">
    ...
    <div class="bt-tp-row">
      ...
      <div class="bt-tp-value bt-tp-value-part">Существует формально · Rada FSM в составе 7–9 человек; председатель — заместитель министра иностранных дел, члены назначаются министром. Президент правления назначается министром на трёхлетнюю каденцию.</div>
    </div>
  </div>
</section>
...
<section class="bt-org-meta">
  <div class="bt-meta-grid">
    ...
    <div class="bt-meta-item">
      ...
      <div class="bt-meta-value">12 июля 2001</div>
    </div>
    <div class="bt-meta-item">
...
FSM — фонд государственной казны Польши под патронатом Президента РП, действующий по заказу МИД Польши. Создан в 1997 году под названием Polska Fundacja Transformacji Rynkowej «Wiedzieć Jak»; нынешнее имя — с февраля 2013 года. Согласно Ustawa o współpracy rozwojowej 2011 года, министр иностранных дел может поручать фонду реализацию задач помощи развитию в странах с особыми политическими условиями.
...
<section class="bt-org-people">
  <div class="bt-block-label">Действующее руководство</div>
  <ul class="bt-org-people-list">
    ...
    <li>Władysław Teofil Bartoszewski — Председатель Rady FSM (заместитель министра иностранных дел РП)</li>
  </ul>
</section>

<section class="bt-org-people">
  <div class="bt-block-label">Бывшее руководство</div>
  <ul class="bt-org-people-list">
    <li>Rafał Dzięciołowski — Президент правления, ушёл с поста в ноябре 2024 года (после публикации аудита NIK)</li>
    <li>Krzysztof Stanowski — Президент правления, 2012–2017</li>
  </ul>
</section>
