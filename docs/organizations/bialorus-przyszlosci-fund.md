...
<section class="bt-org-transparency">
  ...
  <div class="bt-tp-details">
    ...
    <div class="bt-tp-row">
      ...
      <div class="bt-tp-value bt-tp-value-part">Существует формально · надзорный орган присутствует в KRS, но действующий состав сформирован после ухода учредителей 2021 года и вызывает вопросы о независимости от руководителя правления</div>
    </div>
  </div>
</section>
...
<section class="bt-org-money bt-org-money-fragments">
  <div class="bt-block-label">Финансы · засветившиеся гранты</div>
  <p class="bt-org-money-note">Системная финансовая отчётность фонда в открытом реестре отсутствует — отчёты за 2023 и 2024 годы не поданы вопреки обязанности, возникшей с внесением в реестр предпринимателей. Ниже — гранты, ставшие известными через документы грантодателей.</p>

  <ul class="bt-money-fragments-list">
    <li>
      <span class="bt-mf-year">2023</span>
      <span class="bt-mf-amount">980 000 zł<br/>≈ €218 000</span>
      <span class="bt-mf-source">Fundacja Solidarności Międzynarodowej (FSM) — польский публичный грантодатель под патронатом Президента РП и надзором МИД</span>
      <span class="bt-mf-doc"><a href="../archive/doc-fsm-2023-results/">doc-fsm-2023-results</a></span>
      <span class="bt-mf-context">— проект «Opracowanie mapy drogowej dla ochrony praw podstawowych ofiar zbrodni przeciwko ludzkości na Białorusi od 2020 roku». 47% бюджета конкурса FSM 2023 по белорусскому направлению. Документ с результатами удалён с действующего сайта FSM, получен из веб-архива. См. <a href="../events/fsm-grant-competition-2023/">карточку конкурса</a>.</span>
    </li>
  </ul>
