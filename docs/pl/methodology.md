...
<p class="bt-legal-meta">Wersja 1.1 · obowiązuje od 15 maja 2026 roku</p>
...
**Poziom 1 — dokument.** Twierdzenie potwierdzone dokumentem pierwotnym, który widzieliśmy i zachowali w archiwum: oficjalna publikacja, sprawozdanie finansowe, wypis rejestrowy, zrzut ekranu publicznego wpisu, nagranie wystąpienia. To najmocniejsze twierdzenia. Źródło zawsze wskazane z linkiem do karty w naszym [archiwum](../archive/).
...
Jeżeli odpowiedź zostanie udzielona — zostaje wbudowana w publikację.
Jeżeli odpowiedź nie nadejdzie w terminie — publikacja wychodzi z adnotacją „skierowano prośbę, na moment publikacji odpowiedzi nie otrzymano".
Jeżeli odpowiedź przychodzi po publikacji — dodawany jest update z stanowiskiem osoby.
...
1. Każde twierdzenie poziomu 1–2 ma link do źródła w archiwum lub do materiału zewnętrznego
2. Twierdzenia poziomu 3 są jawnie oznaczone jako świadectwa źródła
3. Twierdzenia poziomu 4 są jawnie oznaczone jako rekonstrukcja lub przypuszczenie
4. Wszystkie wymienione osoby i organizacje posiadające karty na stronie są prolinkowane; nowe karty założone, jeśli ich nie było
5. Prośba o komentarz wysłana (jeżeli ma zastosowanie) i termin odpowiedzi upłynął lub odpowiedź otrzymana
6. Metadane dokumentów pierwotnych wyczyszczone, jeżeli istnieje ryzyko dla źródła
7. Dwukierunkowe powiązania w archiwum i kartach zaktualizowane (zob. [zasady archiwum](../archive/))
...
Jeżeli poprawka zmienia sens materiału — wersja oryginalna i poprawiona są zachowane w historii repozytorium git i dostępne przez [archiwum zmian na GitHub](https://github.com/belarustransparency/belarus-transparency/commits/main).
