(function() {
  ...
  function renderMetrics(){
    var items = [
      ...
      { label: 'Анонимных интервью',   value: '3 / 19 000', sub: 'бизнес-единиц беларусов в ЕС' }
    ];
    ...
    var markers = [
      {
        ...
        sub: 'Ключевой источник CASE по барьерам в Польше — отчёт Forum Obywatelskiego Rozwoju (FOR) Babakova, Gomon, Naranovich, Oliński, изданный в партнёрстве с Польско-Украинской торговой палатой. <strong>У FOR нет полевых интервью</strong>: работа стоит на правовом обзоре и анализе открытой статистики <strong>Ministerstwo Rozwoju i Technologii</strong> (Министерство развития и технологий Польши) и <strong>Urząd do Spraw Cudzoziemców</strong> (Управление по делам иностранцев Польши) — каждая таблица подписана как ответ на запрос публичной информации, любой может повторить запрос. CASE опирается на эту работу, <em>добавляет</em> три анонимных интервью и заявляет «mixed-methods».'
      },
      {
        title: 'Открытая публичная статистика — оформлена как «личная коммуникация»',
        sub: 'Латвия (4 584 ВНЖ), Эстония (2 872 ВНЖ) — публичная статистика на сайтах PMLP и PPA; в работе заявлена как личная коммуникация с ведомствами. Обычно это делается для обоснования затрат на ведение полевых исследований.'
      },
      {
